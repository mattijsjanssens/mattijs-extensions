...
//    else
    ...
    (
        mesh,
        meshDict.lookupOrDefault<scalar>("mergeTolerance", 1e-6)
    );
    ...
    {
        Info<< "Naming patches according to region only." << endl;
        namingRule = searchableSurfaces::REGION_ONLY;
    }
    else if (singleRegionName)
    {
        Info<< "Naming patches according to surface only for single regions."
            << endl;
        namingRule = searchableSurfaces::SINGLE_REGION;
    }
    else
    {
        Info<< "Naming patches according to surface and region." << endl;
        namingRule = searchableSurfaces::SURFACE_AND_REGION;
    }
