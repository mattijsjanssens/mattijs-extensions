...
void Foam::structuredFaceAreaPairGAMGAgglomeration::agglomerate
(
    const lduMesh& mesh,
...
)
{
    ...
    while (nCreatedLevels < maxLevels_ - 1)
    {
        ...
        if (nCreatedLevels == 0)
        {
            finalAgglomPtr = structuredAgglomerate
            (
                nCoarseCells,
...
Foam::structuredFaceAreaPairGAMGAgglomeration::agglomerate
(
    label& nCoarseCells,
