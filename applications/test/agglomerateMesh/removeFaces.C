...
) const
{
    ...
    // are only used by 2 unremoved edges.
    {
        ...
        forAll(nEdgesPerPoint, pointi)
        {
            ...
            {
                Pout<< "** point:" << pointi << " at:" << mesh_.points()[pointi]
                    << endl;
                ...
                forAll(pEdges, pEdgei)
                {
                    ...
                    {
                        Pout<< "    removed:" << edgei << ' ' << e << nl;
                    }
                    else
                    {
                        Pout<< "    kept:" << edgei << ' ' << e << nl;
                    }
                    Pout<< "        " << mesh_.points()[e[0]] << nl
                        << "        " << mesh_.points()[e[1]]
                        << endl;
                }
