...
namespace Foam
{
    defineTypeNameAndDebug(GAMGSolver_PPCR, 0);

    lduMatrix::solver::addsymMatrixConstructorToTable<GAMGSolver_PPCR>
        addGAMGSolver_PPCRMatrixConstructorToTable_;

    lduMatrix::solver::addasymMatrixConstructorToTable<GAMGSolver_PPCR>
...
Foam::GAMGSolver_PPCR::GAMGSolver_PPCR
(
...
void Foam::GAMGSolver_PPCR::readControls()
{
...
const Foam::lduMatrix& Foam::GAMGSolver_PPCR::matrixLevel(const label i) const
{
    if (i == 0)
    {
        return matrix_;
...
const Foam::lduInterfaceFieldPtrsList& Foam::GAMGSolver_PPCR::interfaceLevel
(
    const label i
) const
{
...
Foam::GAMGSolver_PPCR::interfaceBouCoeffsLevel
(
    const label i
) const
{
...
const Foam::FieldField<Foam::Field, Foam::scalar>&
Foam::GAMGSolver_PPCR::interfaceIntCoeffsLevel
(
    const label i
) const
{
