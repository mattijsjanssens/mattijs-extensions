...
void Foam::GAMGSolver_PPCR::agglomerateMatrix
(
...
void Foam::GAMGSolver_PPCR::agglomerateInterfaceCoefficients
(
    const label fineLevelIndex,
    const lduInterfacePtrsList& coarseMeshInterfaces,
    PtrList<lduInterfaceField>& coarsePrimInterfaces,
...
void Foam::GAMGSolver_PPCR::gatherMatrices
(
...
) const
{
    if (debug)
    {
        Pout<< "GAMGSolver_PPCR::gatherMatrices :"
...
void Foam::GAMGSolver_PPCR::procAgglomerateMatrix
(
