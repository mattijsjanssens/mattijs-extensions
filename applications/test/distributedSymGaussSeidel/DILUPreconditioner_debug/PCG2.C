...
namespace Foam
{
    defineTypeNameAndDebug(PCG2, 0);

    lduMatrix::solver::addsymMatrixConstructorToTable<PCG2>
        addPCG2SymMatrixConstructorToTable_;
}
...
Foam::solverPerformance Foam::PCG2::scalarSolve
(
...
Foam::solverPerformance Foam::PCG2::solve
(
    scalarField& psi_s,
