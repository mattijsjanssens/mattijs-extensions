...
Foam::Ostream& Foam::UOPstream::write(const char* str)
{
    ...
    {
    std::cout<< "nonWhiteChars:" << nonWhiteChars << std::endl;
    std::cout<< "nonWhiteChars.c_str():" << nonWhiteChars.c_str() << std::endl;
    const char c = nonWhiteChars.c_str()[1];
    //const char c = nonWhiteChars[0];
