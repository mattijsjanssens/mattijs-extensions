...
void kEpsilon2<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kEpsilon2<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kEpsilon2<BasicTurbulenceModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>::New
    (
        epsilon_,
...
template<class BasicTurbulenceModel>
kEpsilon2<BasicTurbulenceModel>::kEpsilon2
(
...
template<class BasicTurbulenceModel>
bool kEpsilon2<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kEpsilon2<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
