...
makeFvLaplacianScheme(gaussLaplacian2Scheme)

#define declareFvmLaplacianScalarGamma(Type)                                   \
                                                                               \
template<>                                                                     \
Foam::tmp<Foam::fvMatrix<Foam::Type>>                                          \
Foam::fv::gaussLaplacian2Scheme<Foam::Type, Foam::scalar>::                    \
fvmLaplacian                                                                   \
(                                                                              \
...
>
Foam::fv::gaussLaplacian2Scheme<Foam::scalar, Foam::scalar>::
fvcLaplacian
(
...
>
Foam::fv::gaussLaplacian2Scheme<Foam::vector, Foam::scalar>::
fvcLaplacian
(
    const GeometricField<scalar, fvPatchField, volMesh>& gamma,
