...
#include "gaussLaplacian2Scheme.H"
...
template<class Type, class GType>
tmp<fvMatrix<Type>>
gaussLaplacian2Scheme<Type, GType>::fvmLaplacianUncorrected
(
...
/*
template<class Type, class GType>
void gaussLaplacian2Scheme<Type, GType>::gradComponent
(
...
gaussLaplacian2Scheme<Type, GType>::gammaSnGradCorr
(
...
gaussLaplacian2Scheme<Type, GType>::fvcLaplacian
(
    const GeometricField<Type, fvPatchField, volMesh>& vf
)
{
...
//- Override already present for Type=scalar,vector. All others are too complex
//    const fvMesh& mesh = this->mesh();
//
//    typedef GeometricField<Type, fvPatchField, volMesh> FieldType;
//
...
//            ),
//            mesh,
//            dimensioned<Type>(gamma.dimensions()*vf.dimensions()/dimArea,
//             Zero),
//            fvPatchFieldBase::extrapolatedCalculatedType()
//        )
//    );
...
template<class Type, class GType>
tmp<fvMatrix<Type>>
gaussLaplacian2Scheme<Type, GType>::fvmLaplacian
(
