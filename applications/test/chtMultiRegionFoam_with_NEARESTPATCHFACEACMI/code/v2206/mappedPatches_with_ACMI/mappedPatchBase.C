...
namespace Foam
{
    defineTypeNameAndDebug(mappedPatchBase2, 0);
}


const Foam::Enum
<
    Foam::mappedPatchBase2::sampleMode
>
Foam::mappedPatchBase2::sampleModeNames_
({
    ...
    { sampleMode::NEARESTPATCHFACEACMI, "nearestPatchFaceACMI" }
});


const Foam::Enum
<
    Foam::mappedPatchBase2::offsetMode
>
Foam::mappedPatchBase2::offsetModeNames_
({
...
Foam::autoPtr<Foam::fileName> Foam::mappedPatchBase2::readDatabase
(
...
bool Foam::mappedPatchBase2::addWorldConnection()
{
    if (sameWorld())
    {
        return true;
...
Foam::label Foam::mappedPatchBase2::getWorldCommunicator() const
{
    if (sameWorld())
    {
...
Foam::tmp<Foam::pointField> Foam::mappedPatchBase2::facePoints
(
    const polyPatch& pp
) const
{
...
void Foam::mappedPatchBase2::collectSamples
(
...
void Foam::mappedPatchBase2::findLocalSamples
(
...
void Foam::mappedPatchBase2::findSamples
(
    const sampleMode mode,
    const label myWorld,
    const pointField& samples,
...
void Foam::mappedPatchBase2::calcMapping() const
{
...
const Foam::autoPtr<Foam::searchableSurface>& Foam::mappedPatchBase2::surfPtr()
const
{
...
void Foam::mappedPatchBase2::calcAMI() const
{
    if (AMIPtr_->upToDate())
    {
        DebugInFunction
...
const Foam::objectRegistry& Foam::mappedPatchBase2::subRegistry
(
...
Foam::mappedPatchBase2::mappedPatchBase2(const polyPatch& pp)
:
    patch_(pp),
    sampleWorld_(),
...
Foam::mappedPatchBase2::mappedPatchBase2
(
    const polyPatch& pp,
...
{
    mappedPatchBase2::setOffset(offsets);
}
...
{
    mappedPatchBase2::setOffset(uniformOffset);
}
...
DebugVar(sampleModeNames_[mode_]);
    ...
    surfDict_(dict.subOrEmptyDict("surface"))
{
    ...
    )
    {
        FatalIOErrorInFunction(dict)
            ...
            << sampleModeNames_[NEARESTPATCHFACEACMI]
            << exit(FatalIOError);
    }
...
void Foam::mappedPatchBase2::clearOut()
{
...
void Foam::mappedPatchBase2::setOffset(const scalar normalDist)
{
    clearOut();
...
void Foam::mappedPatchBase2::setOffset(const vector& uniformOffset)
{
    clearOut();
...
void Foam::mappedPatchBase2::setOffset(const vectorField& offsets)
{
    clearOut();
...
const Foam::polyMesh& Foam::mappedPatchBase2::lookupMesh
(
    const word& sampleRegion
) const
{
...
const Foam::polyPatch& Foam::mappedPatchBase2::lookupPatch
(
    const word& sampleRegion,
    const word& samplePatch
) const
...
const Foam::polyMesh& Foam::mappedPatchBase2::sampleMesh() const
{
...
const Foam::polyPatch& Foam::mappedPatchBase2::samplePolyPatch() const
{
...
Foam::tmp<Foam::pointField> Foam::mappedPatchBase2::samplePoints
(
    const pointField& fc
) const
{
...
Foam::tmp<Foam::pointField> Foam::mappedPatchBase2::samplePoints() const
{
    return samplePoints(facePoints(patch_));
}


Foam::pointIndexHit Foam::mappedPatchBase2::facePoint
(
    const polyMesh& mesh,
    const label facei,
...
Foam::fileName Foam::mappedPatchBase2::sendPath
(
    const fileName& root,
    const label proci
)
...
Foam::fileName Foam::mappedPatchBase2::sendPath(const label proci) const
{
    return sendPath(sampleDatabasePath(), proci);
}


Foam::fileName Foam::mappedPatchBase2::receivePath
(
    const fileName& root,
    const label proci
)
...
Foam::fileName Foam::mappedPatchBase2::receivePath(const label proci) const
{
    return receivePath(sampleDatabasePath(), proci);
}


void Foam::mappedPatchBase2::writeDict
(
    const objectRegistry& obr,
    dictionary& dict
)
...
void Foam::mappedPatchBase2::readDict(const dictionary& d, objectRegistry& obr)
{
...
void Foam::mappedPatchBase2::write(Ostream& os) const
{
    ...
    if (mode_ == NEARESTPATCHFACEAMI || mode_ == NEARESTPATCHFACEACMI)
    {
        if (AMIPtr_)
        {
