...
template<class Type>
void Foam::mappedPatchBase2::distribute(List<Type>& lst) const
{
...
void Foam::mappedPatchBase2::distribute
(
    List<Type>& lst,
    const CombineOp& cop
) const
...
template<class Type>
void Foam::mappedPatchBase2::reverseDistribute(List<Type>& lst) const
{
    const label myComm = getCommunicator();  // Get or create
    const label oldWarnComm(Pstream::warnComm);
    Pstream::warnComm = myComm;
...
template<class Type, class CombineOp>
void Foam::mappedPatchBase2::reverseDistribute
(
    List<Type>& lst,
    const CombineOp& cop
) const
...
template<class Type>
bool Foam::mappedPatchBase2::writeIOField
(
...
template<class Type>
bool Foam::mappedPatchBase2::constructIOField
(
    const word& name,
    token& tok,
    Istream& is,
...
template<class Type>
void Foam::mappedPatchBase2::storeField
(
    objectRegistry& obr,
