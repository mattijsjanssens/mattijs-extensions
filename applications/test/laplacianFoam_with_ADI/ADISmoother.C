...
namespace Foam
{
    defineTypeNameAndDebug(ADISmoother, 0);

    lduMatrix::smoother::addsymMatrixConstructorToTable<ADISmoother>
        addADISmootherSymMatrixConstructorToTable_;

    lduMatrix::smoother::addasymMatrixConstructorToTable<ADISmoother>
        addADISmootherAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::ADISmoother::ADISmoother
(
    ...
    for (label sweep=0; sweep<nSweeps; sweep++)
    {
        ...
        else
        {
            ...
            for (label celli=nCells-1; celli>=0; celli--)
            {
                ...
                // Distribute the owner side using psi for this cell
                for
                (
                    label i = losortStart[celli];
                    i < losortStart[celli+1];
