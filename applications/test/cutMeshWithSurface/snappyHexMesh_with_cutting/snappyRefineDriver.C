...
void Foam::snappyRefineDriver::cutWithSurface()
{
    Info<< nl
        << "Adding additional faces" << nl
        << "-----------------------" << nl
        << endl;
    ...
    // For every point the surface+region it is snapped to
    labelList pointSurfaceRegion;
    // For every edge the surface+region it is snapped to and the weight
    // along the edge
    labelList edgeSurfaceRegion;
    scalarField edgeWeight;
    meshRefiner_.snapToSurface
    (
        pointSurfaceRegion,
        edgeSurfaceRegion,
        edgeWeight
    ...
    // Introduce new faces into mesh
    meshRefiner_.cutWithSurface
    (
        pointSurfaceRegion,
        edgeSurfaceRegion,
        edgeWeight
